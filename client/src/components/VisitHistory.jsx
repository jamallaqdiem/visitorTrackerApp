import React from "react"; // Combined React and useRef
import {
  Search,
  ChevronDown,
  RefreshCcw,
...
  
  // FIX: Ensure dateObj is correctly defined when called
  const dateObj = new Date(isoString);

  // Date format includes day, month, and year (for the top line)
...
      {/*         --- Data Table ---         */}
      <div className="shadow-2xl rounded-xl w-full overflow-x-auto">
...
                    ) : (
                      <span
                        className="px-2 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800"
                      >
                        Still Checked In
                      </span>
                    )}
...
                          <li key={index} className="pl-3 relative before:content-['•'] before:absolute before:left-0 before:text-indigo-400">
                            {dep.full_name} (Age: {dep.age})
                          </li>
                        ))}
                      </ul>
                    ) : (
                      <span className="text-gray-600 pl-5 before:content-['•'] text-xs">None</span>
                    )}
                  </td>
